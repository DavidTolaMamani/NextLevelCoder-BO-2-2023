...
class Dinosaur(Sprite):
    ...
    def __init__(self):
        ...
        self.duck_img = {DEFAULT_TYPE: DUCKING_FLASH, SHIELD_TYPE: DUCKING_FLASH_SHIELD}
        self.run_img = {DEFAULT_TYPE: RUNNING_FLASH, SHIELD_TYPE: RUNNING_FLASH_SHIELD}
        self.jump_img = {DEFAULT_TYPE: JUMPING_FLASH, SHIELD_TYPE: JUMPING_FLASH_SHIELD}
    ...
    def check_invincibility(self, screen, text_utils):
        if self.shield:
            ...
            if time_to_show >= 0:
                if self.show_text:
                      text_utils.show_shield_time(screen, time_to_show)                   
            else:
                self.shield = False
